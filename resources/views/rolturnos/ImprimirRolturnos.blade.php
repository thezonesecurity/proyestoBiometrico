...
<body>
    <div class="form-group row justify-content-center align-content-center mt-4">
        <h3 class="text-uppercase">INFORME PLANILLA DE ASISTENCIA DEL PERSONAL DEL SERVICIO DE {{$extras['servicio']}}</h3>
    </div>
    <div class="form-group row justify-content-center align-content-center">
        <h3 class="text-uppercase">CORRESPONDIENTE AL MES DE {{$extras['gestion']}}</h3>
    </div>
