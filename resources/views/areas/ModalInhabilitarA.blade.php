  ...
  <div class="modal fade" id="abrirModalInhabilitarAreas" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel">Verificacion para Habilitacion / Deshabilitacion de Areas</h5>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
        </div>
        <div class="modal-body">
            {!! Form::open(['route' => 'inhabilitar.area.servicio', 'method' => 'post']) !!}
                ...
                <p style="font-size: 15px;">
                  Se <span id="dato" class="font-weight-bold"></span> el area de <span id="areaMI" class="font-weight-bold"></span> 
                  del servicio de <span id="servicoMI" class="font-weight-bold"></span>. Esta seguro?
                </p>
